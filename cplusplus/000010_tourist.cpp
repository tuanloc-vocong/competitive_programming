 ...
 * the i-th attraction is Ai​​, a unique, non-empty string consisting of at most 20 characters. Each character is either a
 ...
 *
 * Output:
 * For the i-th campus, print a line containing Case #i: followed by K space-separated strings, the names of the attractions that
 * Alex sees on his V-th visit, in decreasing order of popularity.
 *
 * Example 1:
 * Input:
 * 6
