 ...
 *
 * Rash needs to find the number of such pairs of integers l,r that 1≤l≤r≤n and there is at least one pair of integers
 * x,k such that 1≤x,k≤n,l≤x<x+2k≤r, and sx=sx+k=sx+2k​​.
 *
 ...
 *
 * Output:
 * Output one integer: the number of such pairs of integers l,r that 1≤l≤r≤n and there is at least one pair of integers
 * x,k such that 1≤x,k≤n,l≤x<x+2k≤r, and sx=sx+k=sx+2k.
 *
 * Example 1:
 * Input:
